...
bool operator ==(Object other) {
  final _this = this as LocalConfig;
  return identical(this, other) || (other.runtimeType == runtimeType&&other is LocalConfig&&(identical(other.path, _this.path) || other.path == _this.path));
}
...
String toString() {
  final _this = this as LocalConfig;
  return 'LocalConfig(path: ${_this.path})';
}
